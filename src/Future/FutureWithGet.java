...
public class FutureWithGet {
    ...
    public static void main(String[] args) {
        ThreadPoolExecutor threadPoolExecutor1 = new ThreadPoolExecutor(1, 1, 1, TimeUnit.HOURS, new ArrayBlockingQueue<>(10),
                Executors.defaultThreadFactory(), new ThreadPoolExecutor.AbortPolicy());

        //new thread will be created and it will perform the, it's status stored in 'futureobj'
